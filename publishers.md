...
Propose third-party archiving solution (such as Zenodo) if your server cannot accomodate the files submitted by the Authors. They offer solution of private links to give access to the reviewers only and embargo the repository until publication of the article.
