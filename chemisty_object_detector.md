...
In short, repository usually have a .xml file (typically generated by FITS) providing information about the files. A simple [XLST](https://www.w3schools.com/xml/xsl_intro.asp) could extract the elements from the xml file we want to list (as HTML) for the visitor directly access (MIME...open molecule/spectrum).
